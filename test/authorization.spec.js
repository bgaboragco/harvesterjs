...
describe('authorization', function() {
  ...
  describe('when authorizationStrategy returns rejected promise', function() {
    ...
    it('should return 200 status code and forward request to resource when authorization is disabled for that endpoint', function(
      done
    ) {
      request(baseUrl)
        .get('/products')
  ...
  describe('when authorizationStrategy returns resolved promise', function() {
    ...
    it('should return 200 status code and forward request to resource', function(
      done
    ) {
      request(baseUrl)
        .get('/categories')
  ...
  describe('when authorization is disabled only for get resource collection and authorizationStrategy returns resolved promise only for POST product', function() {
    beforeEach(function() {
    ...
    it('should return 200 status code on get collection and forward request to resource', function(
      done
    ) {
      request(baseUrl)
        .get('/products')
