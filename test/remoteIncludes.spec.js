...
describe('remote link', function() {
  describe(
    "given 2 resources : 'posts', 'people' ; defined on distinct harvesterjs servers " +
      "and posts has a remote link 'author' defined to people",
    function() {
      var app1Port = 8011;
      var app2Port = 8012;
      ...
      before(function() {
        ...
        that.harvesterApp1 = harvester(harvesterOptions)
          .resource('post', {
            title: Joi.string(),
            links: {
              author: {
                ref: 'person',
                baseUri: 'http://localhost:' + app2Port,
              },
              comments: ['comment'],
              topic: 'topic',
            },
        ...
        that.harvesterApp2 = harvester(harvesterOptions)
          .resource('person', {
        ...
        return removeCollection(that.harvesterApp1.adapter.model('post'))
          ...
          .spread(function(res, body) {
            ...
            return $http({
              ...
              json: {
                posts: [
                  { title: 'Nodejs rules !', links: { author: that.authorId } },
                ],
              },
            });
          })
          .spread(function(res, body) {
            ...
            return $http({
              ...
              method: 'POST',
              json: {
                comments: [{ body: "That's crazy talk, Ruby is the best !" }],
              },
            });
          })
          .spread(function(res, body) {
